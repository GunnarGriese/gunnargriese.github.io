...
![Usage of reporting identies in GA4](/assets/images/ga4-reporting-identity/ga4-identity-spaces-order.png)
...
![Available reporting identies in GA4](/assets/images/ga4-reporting-identity/ga4-available-reporting-identities.png)
...
![user-id-datalayer-vairable](/assets/images/ga4-reporting-identity/gtm-user-id-dlv.png)
...
![User ID in GA4 settings variable](/assets/images/ga4-reporting-identity/gtm-user-id-settings-variable.png)
...
![GA4 client settings FPID cookie](/assets/images/ga4-reporting-identity/gtm-ss-fpid-cookie.png)
...
![Retroactive User ID assignment in GA4](/assets/images/ga4-reporting-identity/ga4-retroactive-user-id-attribution.png)_Retroactive User ID Attribution_
...
![User ID in User Explorer report in GA4](/assets/images/ga4-reporting-identity/ga4-user-explorer.png)
...
![Proactive User ID attribution in GA4](/assets/images/ga4-reporting-identity/user-id-proactive.png)
...
![Signed in vs. non-signed in users in GA4](/assets/images/ga4-reporting-identity/ga4-signed-in-vs-not-signed-in.png)
...
![Calculate effective user and session id in BigQuery](/assets/images/ga4-reporting-identity/ga4-bq-effective-user-session-id.png)
...
![Behavioral Modeling in GA4](/assets/images/ga4-reporting-identity/behavioral-modeling-data-quality-card.png)
...
![gtm-ss-firestore](/assets/images/ga4-cdp/gtm-ss-firestore.png)
...
![ga4-data-import](/assets/images/ga4-reporting-identity/ga4-data-import.png)
