...
image: /assets/images/blog/firebase-debugging.png
comments: true
lang: en
...
![ga4-data-collection](/assets/images/firebase-debug/ga4-data-collection.png)
...
![gtm-tag-types](/assets/images/firebase-debug/gtm-tag-types.png)
...
![floodlight-tag](/assets/images/firebase-debug/floodlight-tag.png)
...
![firanalyticsdebugenabled](/assets/images/firebase-debug/firanalyticsdebug.png)
...
![debugview-firebase](/assets/images/firebase-debug/debugview-firebase.png)
_DebugView in Firebase Analytics_

…or directly in the GA4 interface.

![debugview-ga4](/assets/images/firebase-debug/debugview-ga4.png)
_DebugView in GA4_
...
![debugging-process](/assets/images/firebase-debug/debugging-process.png)
...
![configure-proxy-connection](/assets/images/firebase-debug/configure-proxy-connection.png)
_4. Configure the network connection_

![download-root](/assets/images/firebase-debug/download-root.png)
_5. Download the CA Root SSL certificate_

![install-certificate](/assets/images/firebase-debug/install-certificate.png)
_6. Install the certificate on your device_

![trust-certificate](/assets/images/firebase-debug/trust-certificate.png)
...
![decoded-protobuf](/assets/images/firebase-debug/decoded-protobuf.png)
...
![webview](/assets/images/firebase-debug/webview.png)
...
![ios-debug-satrt](/assets/images/firebase-debug/ios-debug-satrt.png)
_3. Select a device to debug > Start Debug Session_

![ios-debug-config](/assets/images/firebase-debug/ios-debug-config.png)
_4. Configure your device and set up the proxy_

![ios-debug-root](/assets/images/firebase-debug/ios-debug-root.png)
_5. Downloading and installing the CA Root Certificate (s. Charles Proxy steps)_

![ios-debug-session](/assets/images/firebase-debug/ios-debug-session.png)
...
![ios-debug-requests](/assets/images/firebase-debug/ios-debug-requests.png)
