...
The following diagram illustrates how we can piece together the previously mentioned features to create an engine that's able to power a wide range of data activation use cases:
